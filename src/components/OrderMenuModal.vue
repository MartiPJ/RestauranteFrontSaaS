...
async function loadData() {
  ...
  try {
    const [productsResponse, categoriesResponse] = await Promise.all([
      productService.getProducts(1, 1000), // Para obtener todos los productos
      categoryService.getCategories(1, 1000), // Para obtener todas las categorías
    ])
    // Acceder a la propiedad 'data' que contiene los arrays
      ...
      <div class="modal-container">
        <div class="modal-header">
          <div>
            ...
            <p class="subtitle">Selecciona los productos para la orden</p>
          </div>
